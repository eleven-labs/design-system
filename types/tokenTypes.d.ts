...
export type HeadingSizeType = keyof ((typeof tokenVariables)['mobile']['typography']['heading'] | (typeof tokenVariables)['desktop']['typography']['heading']);
export type TextSizeType = keyof ((typeof tokenVariables)['mobile']['typography']['text'] | (typeof tokenVariables)['desktop']['typography']['text']);

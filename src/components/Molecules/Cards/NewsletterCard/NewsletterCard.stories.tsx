...
import { WebmecanikFormStyles } from '@/integrations';
        ...
        <div id="mauticform_wrapper_abonnementnewsletter" className="mauticform_wrapper">
          ...
          >
            ...
            <div className="mauticform-innerform">
              <div className="mauticform-page-wrapper mauticform-page-1" data-mautic-form-page="1">
                ...
                <div
                  ...
                  className="
                    mauticform-row mauticform-checkboxgrp mauticform-field-2
                    mauticform-required
                  "
                >
                  <div className="mauticform-checkboxgrp-row">
                    ...
                    >
                      J’accepte que la société ELEVEN LABS utilise les informations recueillies à partir de ce
                      formulaire dans le cadre de la gestion de ma demande. Pour en savoir plus, consultez notre{' '}
            ...
            <input
              ...
              id="mauticform_abonnementnewsletter_messenger"
              value="1"
            />
          </form>
        </div>
            ...
            <div className="mauticform-page-wrapper mauticform-page-1" data-mautic-form-page="1">
              ...
              >
                ...
                <span className="mauticform-errormsg">
                  N’oubliez pas de cocher cette case. Il est nécessaire que vous acceptiez de recevoir des informations
                  ne notre part pour que nous puissions répondre à votre demande.
                </span>
              </div>
